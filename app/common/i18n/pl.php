...
return [
    ...
    "Ice is a C extension, so you need to download a binary for your platform or compile it from source code." => "Ice jest rozszerzeniem C, więc trzeba ściągnąć pakiet binarny dla platformy lub skompilować go z kodu źródłowego.",
    "Language" => "Język",
    "License" => "Licencja",
